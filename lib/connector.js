						...
						if (_oldVariantId !== false && _oldVariantId !== undefined && _oldVariantId !== '') {
							...
							_contribution.AttachementsAlternate.forEach((a, akey)=>{
								...
								if (a.Captions[0] === _oldVariantId) {
									_assets[_contribution.AttachementsAlternate[_contribution.AttachementsAlternate.length - 1].Original.split('/').pop()] = a.Captions
									_orderedAssets[_contribution.AttachementsAlternate[_contribution.AttachementsAlternate.length - 1].Original.split('/').pop()] = a.Captions
